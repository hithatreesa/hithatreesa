import { c as createLucideIcon, j as jsxRuntimeExports, a as cn, o, r as reactExports, v as vt, B as Button } from "./index-Dc2kdjSL.js";
import { C as Canvas, u as useFrame } from "./react-three-fiber.esm-wCchHkT3.js";
...
function CTAParticles() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("group", { ref: groupRef, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Stars, { radius: 60, depth: 30, count: 600, factor: 2, fade: true, speed: 0.3 }) });
}
const CONTACT_INFO = [
...
function PreFooterCTA() {
  ...
  const handleSubmit = (e) => {
    ...
    setSubmitted(true);
    ue.success("Thank you! Our team will reach out within 24 hours.");
    setEmail("");
    setCompany("");
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      style: {
        background: "radial-gradient(ellipse 80% 50% at 50% 100%, oklch(0.72 0.22 185 / 0.08) 0%, transparent 60%), oklch(0.13 0.022 265)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Canvas,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(CTAParticles, {})
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider absolute top-0 left-0 right-0" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-6 relative z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-16 items-start", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-2 px-3 py-1 rounded-full border border-primary/25 text-xs font-body font-medium text-primary tracking-widest uppercase mb-6", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1 h-1 rounded-full bg-primary animate-pulse-glow" }),
                  "Get Started Today"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-4xl md:text-5xl font-bold text-foreground mb-6 leading-tight", children: [
                  "Ready to Transform",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text-primary", children: "Your IT?" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground leading-relaxed mb-8", children: "Join hundreds of enterprises across India who trust Terait Technologies to manage their critical IT infrastructure. Request a free consultation and let our experts design the perfect solution for your business." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: CONTACT_INFO.map(({ icon: Icon, label, value }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-xs text-muted-foreground", children: label }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-sm font-medium text-foreground", children: value })
                  ] })
                ] }, label)) })
              ]
            }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-2xl p-8 border border-primary/10", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl text-foreground mb-2", children: "Request a Consultation" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground mb-6", children: "Free, no-obligation discovery call with our enterprise team." }),
                submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-full bg-primary/15 border border-primary/30 flex items-center justify-center mx-auto mb-4 glow-primary", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-6 h-6 text-primary" }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground text-lg mb-1", children: "We'll be in touch!" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground", children: "Expect a response within 24 business hours." }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Button,
                        {
                          variant: "ghost",
                  ...
                  "form",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-muted-foreground text-center", children: "No spam, ever. We respect your privacy." })
                    ]
                  }
                )
              ] })
